...
const Website: React.FC = () => {
  ...
  const websites = [
    { 
      ...
      visits: '1.2M',
      thumbnail: 'https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=1600'
    },
    { 
      id: 2, 
      title: 'Travel Guide', 
      ...
      {selectedSite ? (
        ...
        <div className="p-8">
          <div className="max-w-4xl mx-auto">
            <EarningBanner message="Visit 3 websites to earn $1.00!" />
